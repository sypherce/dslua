...
public:
   ...
   const u8             getScreen()       { return m_nScreen; };
   const u8             getWidth()        { return m_nWidth; };
   const u8             getHeight()       { return m_nHeight; };
   const u8             getMode()         { return m_nMode; };
   const int            getParamIndex()   { return m_nParamIndex; };
