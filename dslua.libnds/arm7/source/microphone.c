...
//---------------------------------------------------------------------------------
	...
	// tob_MIC_On(); // Commented out because the mic is once enabled in arm7 main and then left on
	
	// Setup a timer
	TIMER0_DATA = TIMER_FREQ(16384);
...
//---------------------------------------------------------------------------------
	...
	//tob_MIC_Off(); // Commted out so it is just always left on
	microphone_buffer = 0;
